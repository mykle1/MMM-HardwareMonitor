        ...
        if (typeof graphicsTempCheck !== 'undefined') {
          ...
          finish = dataString.split('.0').join(''); // remove the decimal and tenths digit
            ...
            wrapper.appendChild(graphicsTemp);
                ...
                gpuTemp.innerHTML = "GPU temp = " + Sensors["nouveau-pci-0100"].temp1.current;
                wrapper.appendChild(gpuTemp);

                // GPU temp high
                gpuTempHigh = document.createElement("div");
                gpuTempHigh.classList.add("small", "bright", "gpuTempHigh");
                gpuTempHigh.innerHTML = "GPU temp high = " + Sensors["nouveau-pci-0100"].temp1.limits["0"].high;
                ...
                gpuTempCritical.innerHTML = "GPU temp critical = " + Sensors["nouveau-pci-0100"].temp1.limits[1].crit;
                ...
                gpuTempEmergency.innerHTML = "GPU temp emergency = " + Sensors["nouveau-pci-0100"].temp1.limits[2].emerg;
                ...
                sens1.innerHTML = "Mobo Temp Sensor #1 = " + Sensors["f71858fg-isa-0a00"].temp1.current;
                ...
                sens1Hyst.innerHTML = "HYST = " + Sensors["f71858fg-isa-0a00"].temp1.limits["0"].hyst + " / High = " + Sensors["f71858fg-isa-0a00"].temp1.limits["0"].high;;
                ...
                sens2.innerHTML = "Mobo Temp Sensor #2 = " + Sensors["f71858fg-isa-0a00"].temp2.current;
                ...
                sens2Hyst.innerHTML = "HYST = " + Sensors["f71858fg-isa-0a00"].temp2.limits["0"].hyst + " / High = " + Sensors["f71858fg-isa-0a00"].temp2.limits["0"].high;
                ...
                sensor3.innerHTML = "Mobo Temp Sensor #3 = " + Sensors["f71858fg-isa-0a00"].temp3.current;
                ...
                sens3Hyst.innerHTML = "HYST = " + Sensors["f71858fg-isa-0a00"].temp3.limits["0"].hyst + " / High = " + Sensors["f71858fg-isa-0a00"].temp3.limits["0"].high;
